'use client'
import { z } from 'zod'
import { createAutomations, deleteKeyword, deleteKeywordQuery, saveKeyword, saveListener, savePosts, saveTrigger, updateAutomationName, } from "@/actions/automations"
import { useMutationDataState, useMutationsData } from "./use-mutations-data"
...
export const useCreateAutomation = (id?: string) => {
     ...
     const { isPending, mutate } = useMutationsData(
       ['create-automation'],
...
export const useKeywords = (id: string) => {
  ...
  const { mutate: deleteMutation } = useMutationsData(
    ['delete-keyword'],
